...
* API: [https://github.com/ripoffcoinpay/insight-api-ripoffcoin#instantsend-transactions](https://github.com/ripoffcoinpay/insight-api-ripoffcoin#instantsend-transactions)
...
By default, the Ripoff Coin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ripoff Coin daemon:
