...
Only requiring some minor changes is ripoffcoin.cpp.
...
Changes to ripoffcoin.cpp
----------------------
ripoffcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
