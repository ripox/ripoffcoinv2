...
Ripoff Coin is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Ripoff Coin, where everyone uses
...
pay attention to for reviewers of Ripoff Coin code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ripoff Coin uses tinyformat, which is type safe. Leave them out to avoid confusion
