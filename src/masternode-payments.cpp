...
*
*   Why is this needed?
*   - In RIPO some blocks are superblocks, which output much higher amounts of coins
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward, CTxOut& txoutMasternodeRet)
{
    ...
    CAmount masternodePayment = GetMasternodePayment(nBlockHeight, true);
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
    ...
    CAmount nMasternodePayment = GetMasternodePayment(nBlockHeight, true);
    ...
    LogPrintf("CMasternodeBlockPayees::IsTransactionValid -- ERROR: Missing required payment, possible payees: '%s', amount: %f RIPO\n", strPayeesPossible, (float)nMasternodePayment/COIN);
    return false;
}
