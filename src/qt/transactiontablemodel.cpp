...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::RecvWithPrivateSend:
        return tr("Received via DDNSend");
    ...
    case TransactionRecord::PrivateSendDenominate:
        return tr("DDNSend Denominate");
    case TransactionRecord::PrivateSendCollateralPayment:
        return tr("DDNSend Collateral Payment");
    case TransactionRecord::PrivateSendMakeCollaterals:
        return tr("DDNSend Make Collateral Inputs");
    case TransactionRecord::PrivateSendCreateDenominations:
        return tr("DDNSend Create Denominations");
    case TransactionRecord::DDNSend:
        return tr("DDNSend");
