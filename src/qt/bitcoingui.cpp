    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("RIPO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RIPO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ripoffcoin: URIs)"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/" + theme + "/masternodes"), tr("&A.S.S. Nodes"), this);
        masternodeAction->setStatusTip(tr("Browse A.S.S. Nodes"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About RIPO Core"), this);
    aboutAction->setStatusTip(tr("Show information about RIPO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RIPO Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RIPO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RIPO addresses"));
    ...
    usedSendingAddressesAction = new QAction(QIcon(":/icons/" + theme + "/address-boo k"), tr("&Sending addresses..."), this);
    ...
    openAction->setStatusTip(tr("Open a ripoffcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RIPO Core help message to get a list with possible RIPO Core command-line options"));

    showPrivateSendHelpAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&DDNSend information"), this);
    showPrivateSendHelpAction->setMenuRole(QAction::NoRole);
    showPrivateSendHelpAction->setStatusTip(tr("Show the DDNSend basic information"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("RIPO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RIPO network", "", count));
    } else {
...
{
    QString strTitle = tr("RIPO Core"); // default title
