    ...
    transactionView(0), abandonAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("DDNSend"), TransactionFilterProxy::TYPE(TransactionRecord::DDNSend));
    typeWidget->addItem(tr("DDNSend Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::PrivateSendMakeCollaterals));
    typeWidget->addItem(tr("DDNSend Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::PrivateSendCreateDenominations));
    typeWidget->addItem(tr("DDNSend Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::PrivateSendDenominate));
    typeWidget->addItem(tr("DDNSend Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::PrivateSendCollateralPayment));
