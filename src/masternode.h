...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 20000RIP, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 20000 RIPO - checking if valid masternode)
