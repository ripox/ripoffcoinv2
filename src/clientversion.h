...
//! These need to be macros, as clientversion.cpp's and ripoffcoin*-res.rc's voodoo requires it
...
/**
 * ripoffcoind-res.rc includes this file, but it cannot cope with real c++ code.
