...
2. run ripoffcoind with -printalert or -sendalert like this:
   /path/to/ripoffcoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.ripoffcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/RIPO Core:0.12.0.58/"));
