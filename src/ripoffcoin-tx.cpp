...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("RIPO Core ripoffcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ripoffcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ripoffcoin transaction") + "\n" +
              "  ripoffcoin-tx [options] -create [commands]   " + _("Create hex-encoded ripoffcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ripoffcoin transaction
