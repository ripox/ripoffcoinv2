...
//
// Why bother? DDNSend uses collateral to ensure abuse to the process is kept to a minimum.
...
/*
    ...
    allow endless transaction that would bloat RIPO and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("ripoffcoin-ps-server");
